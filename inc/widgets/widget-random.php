 ...
 * @since      1.0.0
 */
class TrueReview_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-truereview-random posts-thumbnail-widget',
			'description' => esc_html__( 'Display random posts with thumbnails.', 'truereview' )
		);

		// Create the widget.
		parent::__construct(
			'truereview-random',                                           // $this->id_base
			esc_html__( '&raquo; Random Posts Thumbnails', 'truereview' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'truereview' ),
			'limit'     => 5,
			'show_date' => false,
			'style'     => 'default'
		);
